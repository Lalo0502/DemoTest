...
export default function OrdersPage() {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center text-center">
      ...
      <h1 className="mt-8 text-2xl font-semibold">Gestión de Órdenes</h1>
      <p className="mt-4 max-w-md text-muted-foreground">
        Esta sección está actualmente en desarrollo. Pronto podrás gestionar todas tus órdenes desde aquí.
      </p>
    </div>
  );
}