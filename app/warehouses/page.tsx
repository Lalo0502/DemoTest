...
export default function WarehousesPage() {
  return (
    <div className="flex min-h-[60vh] flex-col items-center justify-center text-center">
      ...
      <h1 className="mt-8 text-2xl font-semibold">Gestión de Almacenes</h1>
      <p className="mt-4 max-w-md text-muted-foreground">
        Esta sección está actualmente en desarrollo. Pronto podrás administrar tus almacenes desde aquí.
      </p>
    </div>
  );
}